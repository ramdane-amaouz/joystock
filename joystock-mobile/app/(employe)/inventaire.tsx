...
export default function Inventaire() {
  ...
  async function exporterCSV(inventaire: Inventaire) {
    ...
    try {
      ...
      await FileSystem.writeAsStringAsync(fichier, entete + contenu, {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 32 }}>
      ...
      <TouchableOpacity
        style={styles.carte}
        onPress={() => router.push('/(employe)/pages_cachees/demarrer-inventaire' as any)}
        activeOpacity={0.7}
      >
      ...
      <TouchableOpacity
        style={styles.carte}
        onPress={() => router.push('/(employe)/pages_cachees/reception-livraison' as any)}
        activeOpacity={0.7}
      >
        <Text style={styles.carteIcone}>📦</Text>
        <View style={styles.carteTextes}>
